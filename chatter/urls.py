...
urlpatterns = [
    ...
    path('home/post/<int:post_pk>/comment/<int:pk>/like', views.commentlikes, name= 'commentlikes'),
    path('home/post/<int:post_pk>/comment/<int:pk>/dislike', views.commentdislikes, name= 'commentdislikes'),
    path('home/post/<int:post_pk>/comment/<int:parent_pk>/child/<int:pk>/like', views.childcommentlikes, name= 'childcommentlikes'),
    path('home/post/<int:post_pk>/comment/<int:parent_pk>/child/<int:pk>/dislike', views.childcommentdislikes, name= 'childcommentdislikes'),    
    path('home/post/<int:post_pk>/comment/<int:pk>/reply', views.replycomments, name='commentreplies'),
    path('home/<int:pk>/like/', views.likes, name= 'likes'),
    path('home/post/<int:pk>/dislike/', views.dislikes, name= 'dislikes'),
    ...
    path('messages/<int:pk>/createmessage/', views.createmessage, name= 'createmessage'),    
